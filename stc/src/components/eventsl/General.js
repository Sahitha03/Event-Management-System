...
function GEneral() {
  const [dept, setDept] = useState(GeneralFile)
  ...
  return (
    <div className="App">
      ...
      <Grid 
              ...
              gap={5}
          > 
      {GeneralFile.map((mb) => (<Grid sx={{ minWidth: 400, minHeight: 300, margin: 6, border: '4px outset black', borderRadius: 5, backgroundColor: "lime", fontFamily:"Times new roman", fontSize:"20px", borderWidth:"3px"}} item xs={12} sm={6} md={3} key={mb.id}>{mb.img}<br/>Name:{mb.name}<br/>Price:{mb.price}<br/> 
